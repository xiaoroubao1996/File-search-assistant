...
QUI        :        
        'qui ��crit article' | 'quel auteur ��crit article'
        ;
...
PARLER        :
        'publier'|'parler'|'concerner'| 'sur'| 'contenir' | 'font r��f��rence' | 'parus bulletins'
        ;
...
requete returns [Arbre req_arbre = new Arbre("")]
        @init {Arbre join_arbre; String modele_avant = ""; String modele_apres= "";String modele_group= "titretexte";String sujet2= "";} : 
                (((SELECT 
                        {
