...
class AnalyseSyntaxique {
    ...
    public AnalyseSyntaxique(String Requete) {
        ...
        try {
            // Lexiques
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/TD7/src/lexique.txt"));
            ...
            br.close();
            // Stop lists
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/TD7/src/stoplist.txt"));
            while ((chaine = br.readLine()) != null)
                Stoplist.add(chaine);
            br.close();
            // Lemmes
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/TD7/src/filtronc.txt"));
            while ((chaine = br.readLine()) != null) {
                String[] MotLemme = chaine.split(" \t");
