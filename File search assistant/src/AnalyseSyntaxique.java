...
class AnalyseSyntaxique {
    ...
    private static HashMap<String, String> DictionnaireInverse = new HashMap<>();
    private static HashMap<String, String> Lemme = new HashMap<>();
    private static HashMap<String, String> LemmeInverse = new HashMap<>();
    ...
    public static HashMap<String, String> getDictionnaire() {
        return Dictionnaire;
    }
    public static HashMap<String, String> getDictionnaireInverse() {
        return DictionnaireInverse;
    }
    public static HashMap<String, String> getLemme() {
        return Lemme;
    }
    public static HashMap<String, String> getLemmeInverse() {
        return LemmeInverse;
    }
    public static Set<String> getStoplist() {
        return Stoplist;
    }
    ...
    public AnalyseSyntaxique(String Requete) {
        ...
        try {
            // Lexiques
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/ProjetFinal/resources/lexique.txt"));
            while ((chaine = br.readLine()) != null) {
                String[] MotLemme = chaine.split(" ");
                Dictionnaire.put(MotLemme[0], MotLemme[1]);
                DictionnaireInverse.put(MotLemme[0], MotLemme[0]);
            }
            br.close();
            // Stop lists
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/ProjetFinal/resources/stoplist.txt"));
            while ((chaine = br.readLine()) != null) {
                Stoplist.add(chaine);
                LemmeInverse.put(chaine, chaine);
            }
            br.close();
            // Lemmes
            br = new BufferedReader(new FileReader("/Users/long/Documents/_lo17/lo17/ProjetFinal/resources/filtronc.txt"));
            while ((chaine = br.readLine()) != null) {
                String[] MotLemme = chaine.split(" \t");
                Lemme.put(MotLemme[0], MotLemme[1]);
                LemmeInverse.put(MotLemme[0], MotLemme[0]);
            }
            br.close();
        }
